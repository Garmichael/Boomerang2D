...
namespace Boomerang2DFramework.Framework.Actors.TriggerSystem.Triggers {
	[Serializable]
	public class LinkedActorOverlapsColliderWithFlag : ActorTrigger {
		[SerializeField] private LinkedActorOverlapsColliderWithFlagProperties _properties;

		public LinkedActorOverlapsColliderWithFlag(ActorTriggerProperties actorTriggerProperties) {
			_properties = (LinkedActorOverlapsColliderWithFlagProperties) actorTriggerProperties;
		}
