...
namespace Boomerang2DFramework.Framework.Actors.TriggerSystem.Triggers {
	[Serializable]
	public class DoesntOverlapTileFlag : ActorTrigger {
		[SerializeField] private DoesntOverlapTileFlagProperties _properties;

		public DoesntOverlapTileFlag(ActorTriggerProperties actorTriggerProperties) {
			_properties = (DoesntOverlapTileFlagProperties) actorTriggerProperties;
		}
